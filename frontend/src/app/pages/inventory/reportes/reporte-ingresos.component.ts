    ...
    <div class="page-container">
      <div class="page-header">
        <div class="header-content">
          ...
          <p>Historial completo de ingresos al inventario</p>
        </div>
      ...
      <div class="filters-bar">
        ...
        <div class="filter-group">
          ...
          <input type="text" class="form-input" placeholder="Buscar proveedor..." />
        </div>
        ...
        <table class="data-table">
          ...
          <tbody>
            <tr *ngIf="ingresos.length === 0">
              <td colspan="6" class="empty-row">No hay ingresos para mostrar</td>
            </tr>
